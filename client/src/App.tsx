...
function AppLayout() {
  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-hidden bg-[#f8faFC] dark:bg-black transition-colors duration-500">
      ...
      {user && (
          <footer className="w-full bg-[#0a0a0a]/90 backdrop-blur-md border-t border-white/5 py-12">
            <div className="container max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
              ...
              <div className="flex flex-col items-center md:items-start cursor-pointer">
                ...
                <p className="text-gray-400 text-xs text-center md:text-left mt-2 max-w-sm">
              ...
              <div className="flex items-center gap-8">
                <div className="flex items-center gap-5">
                  <a href="https://www.facebook.com/petcareai" className="text-[#ff6b4a] hover:text-white transition-colors">
                  ...
                  <a href="https://www.instagram.com/petcareai_official/" className="text-[#ff6b4a] hover:text-white transition-colors">
                  ...
                  <a href="https://www.youtube.com/@PetCareAI" className="text-[#ff6b4a] hover:text-white transition-colors">
